                ...
                <Grid container spacing={4} style={{alignItems: "center"}}>
                    ...
                    <Grid item xs={7}>
                        <Container maxWidth="md">
                            ...
                            <Typography variant="h6" className={classes.body} color="primary" align="left">
                                <b>Skills:</b> Python, Microsoft Azure , pandas, SQLAlchemy, PosgreSQL, Postman, unittest
                            </Typography>
                            ...
                            <Typography variant="h6" className={classes.body} color="primary" align="left" style={{textIndent: "40px"}}>
                                ...
                                import and analyze data about the Earth such as precipitation and seismic activities. While
                                on my co-op term at BGC, I've gained skills as a full stack developer as well the necessary
