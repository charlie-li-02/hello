...
import StarStack from "../../StarStackMobile";
    ...
    return (
        <div className="Skills">
                ...
                <Grid container spacing={3} style={{alignItems: "flex-start"}} className={classes.subHeading}>
                    ...
                    <Grid item xs={12} data-aos="fade-up">
                        <Stack direction={"row"} style={{justifyContent:"center", alignItems:"flex-end"}}>
                            <StarStack text={""} stars={0}/>
                            <Typography variant="h6" color="primary" style={{fontSize:13, textIndent: "12px"}}>
                                currently acquiring
                            </Typography>
                        </Stack>
