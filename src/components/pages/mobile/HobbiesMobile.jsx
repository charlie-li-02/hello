...
import GamesImageList from "../../GamesImageListMobile";
import GundamImageListTop from "../../GundamImageListTopMobile";
import AOS from 'aos';
    ...
    return (
        <div className="Hobbies">
            <MuiThemeProvider theme={Look.theme}>
                ...
                <Typography variant="h6" className={classes.body} style={{marginLeft: "5px", marginRight: "5px"}} color="primary" align="center" >
                ...
                <Container maxWidth={false} data-aos="fade-up">
                    <Divider style={{fontSize: "18px", marginTop:"15px"}} data-aos="fade-up">GUNPLA</Divider>
                    <div className={classes.smallSpace} />
                ...
                <Container maxWidth={false} data-aos="fade-up">
                    <Divider style={{fontSize: "18px", marginTop:"15px"}} data-aos="fade-up">GAMING</Divider>
                    <div className={classes.smallSpace} />
                    <Stack direction="column" alignItems="center" justifyContent="center">
                        <GamesImageList/>
                ...
                <Container maxWidth={false} data-aos="fade-up">
                    <Divider style={{fontSize: "18px", marginTop:"15px"}} data-aos="fade-up">READING</Divider>
                    <div className={classes.smallSpace} />
